 ...
 */
package com.premierinnprogram.shared.hotel.directory.core.models;
...
import com.premierinnprogram.shared.hotel.directory.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "test-projectb/components/helloworld");
